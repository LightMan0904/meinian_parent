...
public class MessageConstant {
    ...
    public static final String GET_ADDRESS_SUCCESS = "查询地址信息成功";
    public static final String GET_ADDRESS_FAIL = "查询地址信息失败";
    public static final String QUERY_ADDRESS_SUCCESS = "查询地址详细信息成功";
    public static final String QUERY_ADDRESS_FAIL = "查询地址详细信息失败";
