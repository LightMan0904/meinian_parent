...
public class QiniuUtils {
    ...
    public  static String accessKey = "4H2k1XONLkml9YcuPVSp3gsWXg9WhqKRDn7u-WAq";
    public  static String secretKey = "NKecIgLIxet2gLSPzCYqhoLQ18EeEjqILIOnCl55";
    public  static String bucket = "qiniu-meinian";
